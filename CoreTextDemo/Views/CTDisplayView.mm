...
//            CGContextDrawImage(context, imageData.imagePosition, image.CGImage);
            ...
            rectView *view = [[rectView alloc]initWithFrame:CGRectMake(imageData.imagePosition.origin.x, self.height - imageData.imagePosition.origin.y - imageData.imagePosition.size.height, imageData.imagePosition.size.width, imageData.imagePosition.size.height)];
